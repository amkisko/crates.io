...
diesel::table! {
    ...
    api_mfa_rate_limit_buckets (bucket_key, action) {
        /// Opaque SHA-256 key derived from challenge id and client IP
        bucket_key -> Varchar,
        /// The limited action discriminator
        action -> Int4,
...
diesel::table! {
    ...
    api_mfa_challenges (id) {
        ...
        /// (Automatically generated by Diesel.)
        id -> Varchar,
        /// The `localhost_callback_secret_hash` column of the `api_mfa_challenges` table.
        ///
        /// Its SQL type is `Nullable<Bytea>`.
        ///
        /// (Automatically generated by Diesel.)
        ...
        /// SHA-256 binding this approval to the exact server-parsed mutation
        ...
        /// The exact endpoint path bound during mutation preflight.
        request_endpoint -> Nullable<Varchar>,
        /// The exact HTTP method bound during mutation preflight.
        request_method -> Nullable<Varchar>,
        /// SHA-256 of the raw final mutation request body.
        request_sha256 -> Nullable<Bytea>,
        /// Length of the raw final mutation request body.
        request_size -> Nullable<Int8>,
        /// Terminal response body replayed for idempotent mutation retries
        response_body -> Nullable<Bytea>,
        /// Selected terminal response headers for idempotent replay.
        response_headers -> Nullable<Jsonb>,
        /// Terminal HTTP status for idempotent replay.
        response_status -> Nullable<Int4>,
        /// Encrypted OTP for callback-secret-authenticated browser recovery
        sealed_otp -> Nullable<Varchar>,
        /// When the mutation reached a terminal outcome.
...
diesel::table! {
    ...
    api_mfa_grants (id) {
        ...
        /// (Automatically generated by Diesel.)
        id -> Int8,
        /// SHA-256 binding this grant to an exact mutation; NULL only for cookie wildcard grants
